# 🚀 LỆNH REFREST LẠI DỰ ÁN (XÓA ĐI NHỮNG TỆP NẶNG)
# DÙNG Ở THƯ MỤC GỐC
` Remove-Item -Path .\client\node_modules, .\client\.next, .\server\node_modules, .\server\dist -Recurse -Force -ErrorAction SilentlyContinue `
...
## 📂 Danh sách các Script: DÙNG Ở THƯ MỤC SERVER
