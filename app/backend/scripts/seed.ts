...
async function seedDatabase() {
  ...
  try {
    ...
    const collectionsToReset = ['users', 'channels', 'videos', 'comments', 'playlists', 'orders', 'advertisements', 'ad_settings', 'admins', 'withdrawals', 'tickets', 'notifications', 'wallettransactions', 'premiumpackages'];
    ...
    // 3.1.b. Seed VIP Administrator Admin in admins collection
    const adminDoc = {
      email: 'admin@mytube.com',
      name: 'Super Admin',
      role: 'ADMIN',
      avatar_url: '/assets/img/default-admin-avatar.jpg',
      balance: 0,
      isActive: true,
      createdAt: new Date(),
      updatedAt: new Date()
    ...
    console.log('  - Seeded Administrator Admin "Super Admin" (admin@mytube.com) in admins collection');
    ...
    // 3.6. Seed Default AdSettings & Advertisements
    await db.collection('ad_settings').insertOne({
      globalAdEnabled: true,
      createdAt: new Date(),
      updatedAt: new Date()
    });
    console.log('  - Seeded default global AdSetting (globalAdEnabled = true)');

    const defaultAds = [
      {
        slotId: 'homepage_main_1',
        ...
        mediaUrl: '/assets/img/banner1.jpg',
        linkUrl: '/',
        badgeText: 'Nổi bật',
        isActive: true,
        isMuted: true,
        ...
        pricingModel: 'CPD',
        pricePerUnit: 0,
        advertiserName: 'Hệ thống',
        lastActiveStartAt: new Date(),
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        slotId: 'homepage_main_2',
        ...
        mediaUrl: '/assets/img/banner2.png',
        linkUrl: '/',
        badgeText: 'Nổi bật',
        isActive: true,
        isMuted: true,
      ...
      {
        slotId: 'homepage_sub_1',
        title: 'XANH SM',
        description: 'Taxi Điện & Xe Máy Điện Tiên Phong - Đặt xe dễ dàng',
        mediaUrl: '/assets/img/bannerXanhSM.png',
        linkUrl: 'https://www.xanhsm.com/',
        badgeText: 'Tài trợ',
        isActive: true,
        isMuted: true,
        status: 'ACTIVE',
      ...
      {
        slotId: 'homepage_sub_2',
        title: 'LIFEBUOY VIỆT NAM',
        description: 'Sạch khuẩn 99.9% - Bảo vệ đề kháng da tự nhiên',
        mediaUrl: '/assets/img/lifebuoy_ad.png',
        linkUrl: 'https://www.lifebuoy.vn/',
        badgeText: 'Tài trợ',
        isActive: true,
        isMuted: true,
        status: 'ACTIVE',
      ...
      },
      {
        ...
        title: 'Quảng cáo Xanh SM Pre-roll 1',
        description: 'Quảng cáo Xanh SM trước khi chạy video số 1',
        mediaUrl: 'https://www.youtube.com/embed/ZPcCfW4JNO0?autoplay=1&mute=0&controls=0&modestbranding=1&rel=0&iv_load_policy=3&enablejsapi=1&showinfo=0',
        linkUrl: 'https://www.xanhsm.com/',
        badgeText: 'Ad',
        isActive: true,
        isMuted: true,
      ...
      {
        slotId: 'video_preroll_2',
        title: 'Quảng cáo VinFast Pre-roll 2',
        description: 'Quảng cáo xe điện VinFast thông minh số 2',
        mediaUrl: 'https://res.cloudinary.com/demo/video/upload/elephants.mp4',
        linkUrl: 'https://vinfastauto.com/',
        badgeText: 'Ad',
        isActive: true,
        isMuted: true,
        status: 'ACTIVE',
    ...
    await db.collection('advertisements').insertMany(defaultAds);
    console.log('  - Seeded 8 default advertisement slots');
