    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (step === 1) {
            ...
            try {
                ...
                if (res.ok) {
                    sessionStorage.setItem('admin_token', JSON.stringify(data.admin)); // Save to sessionStorage
                    router.push('/admin');
                } else {
                    ...
                    <div className="flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-700">
                        <div className="flex items-center gap-2 group">
                            ...
                            <span className="text-zinc-950 dark:text-white font-black text-2xl tracking-tighter">
                                ...
                                <span className="text-red-500 font-bold text-xs px-2 py-0.5 rounded-full bg-red-500/10 border border-red-500/20 ml-2 relative top-[-3px]">ADMIN</span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="max-w-xl my-auto space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000 delay-150">
                        <div className="space-y-4">
                            ...
                            <p className="text-zinc-500 dark:text-white/40 text-base leading-relaxed font-medium">
                                Cổng đăng nhập quản trị nội bộ MyTube được tăng cường bằng cơ chế mật khẩu OTP dùng một lần, mã hóa phiên làm việc chuẩn JWT và chuyển tiếp bảo mật không qua trung gian.
                            </p>
                        </div>
                    ...
                    <div className="w-full max-w-sm mx-auto lg:mr-16 xl:mr-28 p-10 lg:p-0 relative z-30 animate-in fade-in zoom-in-95 duration-500">
                        ...
                        <div className="flex flex-col items-center lg:items-start text-center lg:text-left mb-8 lg:mb-10">
                            ...
                            <h1 className="text-3xl font-black text-zinc-900 dark:text-white tracking-tight lg:leading-tight">
                                Quản trị <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-rose-500">MyTube</span>
                            </h1>
                            <p className="text-zinc-500 dark:text-white/40 text-xs mt-2 font-medium">Đăng nhập tài khoản Admin bảo mật qua Discord Bot</p>
                        </div>
                        ...
                        {success && (
                            <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 p-4 rounded-2xl mb-6 text-xs flex items-center gap-3 animate-in fade-in slide-in-from-top-2 duration-300 font-semibold">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-zinc-400 dark:text-white/40 uppercase tracking-widest block">Số điện thoại quản trị</label>
