      ...
      if (apiData && apiData.video) {
        data = {
          video: {
            ...
            channel_is_verified: apiData.video.channel?.is_verified,
        ...
        try {
          ...
          if (commentsRes.ok) {
            ...
            data.comments = rawComments.map((c: any) => ({
              ...
              premium_show_avatar_aura: c.user?.premium_show_avatar_aura !== false,
              premium_show_comment_aura: c.user?.premium_show_comment_aura !== false,
              content: c.content,
              ...
              replies: c.replies?.map((r: any) => ({
                ...
                premium_show_avatar_aura: r.user?.premium_show_avatar_aura !== false,
                premium_show_comment_aura: r.user?.premium_show_comment_aura !== false,
                content: r.content,
