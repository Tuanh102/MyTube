        ...
        <div className="relative" ref={dropdownRef}>
          {user ? (
            <div className="relative flex items-center justify-center">
              {(user.is_premium && (user as any).premium_show_avatar_aura !== false) ? (
                ...
                <div className="flex items-center gap-4 pt-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 mt-1.5">
                      <span className="bg-zinc-800 text-yellow-500 border border-yellow-500/20 text-[10px] font-bold px-2.5 py-1 rounded-full flex items-center gap-1">
                        Ví: {((user as any)?.balance || 0).toLocaleString('vi-VN')} Coins ({(((user as any)?.balance || 0) * 1000).toLocaleString('vi-VN')} đ)
                      </span>
                    </div>
                  </div>
                </div>
