...
export default function AdminDashboard() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white flex">
            {/* Sidebar */}
            <aside className="w-64 border-r border-white/5 bg-[#0f0f0f] hidden lg:flex flex-col">
                ...
                <nav className="flex-1 px-4 space-y-1">
                    <div className="text-white/20 text-[10px] font-bold uppercase tracking-widest px-4 mb-4 mt-4">Menu chính</div>
                    <button className="w-full flex items-center gap-3 px-4 py-3 bg-red-600 rounded-xl text-white font-bold transition-all">
                        <LayoutDashboard size={18} />
                        <span>Tổng quan</span>
                    </button>
                    <button className="w-full flex items-center gap-3 px-4 py-3 text-white/40 hover:text-white hover:bg-white/5 rounded-xl font-medium transition-all">
                        <Video size={18} />
                ...
                <div className="p-4 border-t border-white/5">
                    <button 
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 text-red-500/60 hover:text-red-500 hover:bg-red-500/10 rounded-xl font-medium transition-all"
                    >
                        <LogOut size={18} />
                        <span>Đăng xuất</span>
                    </button>
