...
import { Shield, Lock, Phone, ArrowRight, CheckCircle2, AlertCircle, RefreshCw, Cpu, Layers, Send, Key } from 'lucide-react';
            ...
            <div className="w-full h-screen flex relative z-10">
                ...
                <div className="hidden lg:flex flex-col justify-between w-[50vw] h-full p-20 select-none relative z-10">
                    ...
                    <div className="flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-700">
                        ...
                        <span className="text-white font-black text-xl tracking-wider">MyTube <span className="text-red-500 font-medium text-xs px-2 py-0.5 rounded-full bg-red-500/10 border border-red-500/20 ml-1">ADMIN</span></span>
                    </div>
                    ...
                    <div className="w-full max-w-sm mx-auto lg:mr-16 xl:mr-28 p-10 lg:p-0 relative z-30 animate-in fade-in zoom-in-95 duration-500">
                        ...
                        <div className="flex flex-col items-center lg:items-start text-center lg:text-left mb-8 lg:mb-10">
                            ...
                            <h1 className="text-3xl font-black text-white tracking-tight lg:leading-tight">
                                Quản trị <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-rose-500">MyTube</span>
                            </h1>
                            <p className="text-white/40 text-xs mt-2">Đăng nhập tài khoản Admin bảo mật qua Discord Bot</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-white/40 uppercase tracking-widest block">Số điện thoại quản trị</label>
